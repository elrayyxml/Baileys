    ...
    return {
        ...
        if (waMsgContent.message) {
            ...
            if (waMsgContent.message[messageType]) {
                ...
                if (content.backgroundColor || content.textColor || content.font !== undefined) {
                    if (messageType === 'extendedTextMessage') {
                        waMsgContent.message[messageType] = {
                            ...messageContent,
                            ...(content.backgroundColor && { backgroundArgb: content.backgroundColor }),
                            ...(content.textColor && { textArgb: content.textColor }),
                            ...(content.font !== undefined && { font: content.font })
                        };
        ...
        const msg = await Utils_1.generateWAMessageFromContent(
            ...
            groupStoryContent,
            {
                userJid: this.user?.id || this.getUserJid()
            }
        );

        await this.relayMessage(normalizedJid, msg.message, {
